...
- (void)setMenuState:(MFSideMenuState)menuState completion:(void (^)(void))completion {
    ...
    switch (menuState) {
        case MFSideMenuStateClosed: {
            ...
            //[self.centerViewController view].center = CGPointMake([UIScreen mainScreen].bounds.size.width/2,[UIScreen mainScreen].bounds.size.height/2);
            //[self.centerViewController view].transform = CGAffineTransformScale(CGAffineTransformIdentity,1,1);
...
//            [UIView beginAnimations:nil context:nil];
//            [self.centerViewController view].transform = CGAffineTransformScale(CGAffineTransformIdentity,1,0.9);
//            [self.centerViewController view].center = CGPointMake(340,[UIScreen mainScreen].bounds.size.height/2);
//            [UIView commitAnimations];
